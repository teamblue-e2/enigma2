		...
		if WEATHER_LOAD == True:
			try:
				...
				if r != None and r <= 1.5:
					...
					res = requests.get('http://weather.service.msn.com/data.aspx?src=windows&weadegreetype=C&culture=de-DE&wealocations=' + str(config.plugins.PaxWeather.gmcode.value), timeout=1.5)
