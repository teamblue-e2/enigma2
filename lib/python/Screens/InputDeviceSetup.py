...
class RemoteControlType(ConfigListScreen, Screen):
	rcList = [
			...
			("13", "et4000"),
			("14", "xp1000"),
			("16", "HDx1/HD1xxx/HD5x0C/VS1x00/et7x00/et8500/et7000mini"),
			("18", "F1/F3/F4/F4-TURBO"),
			("19", "HD2400"),
			("20", "Zgemma Star S/2S/H1/H2"),
			("21", "Zgemma H.S/H.2S/H.2H/H5/H7(old model)"),
			("24", "Axas E4HD Ultra"),
			("25", "Zgemma H9(old model)/I55Plus/H8"),
			("27", "HD60/HD66SE/Multibox/Multibox SE"),
			("28", "I55SE/H7(new model)/H9(new model)/H9COMBO/H9TWIN/H9SE/H9COMBOSE/H10/H11"),
			("30", "PULSe 4K(mini)")
		]
